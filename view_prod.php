...
<div class="container-fluid">
	...
	<div class="card " style="display: flex; justify-content: center; align-items: center;">
        ...
        <div class="card-body">
		  ...
		  <h6 class="card-title">Unit Price : Rs. <?php echo $qry['price'] ?></h6>
		  <p class="card-title"><i>Description: <?php echo $qry['description'] ?></i></p>
          ...
          <div class="row">
			  ...
			  <input type="hidden" value="<?php echo $qry['user_id']; ?>" name="prod_owner">
			  <div class="input-group-prepend">
...
<script>
	...
	$('#add_to_cart_modal').click(function(){
		...
		$.ajax({
			...
			method:'POST',
			data:{pid:'<?php echo $_GET['id'] ?>',qty:$('[name="qty"]').val(),prod_owner:$('[name="prod_owner"]').val()},
