            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-10 align-self-end mb-4" style="background: rgba(0, 0, 0, 0);">
                    	 <h1 class="text-uppercase text-black font-weight-bold">Order History</h1>
                    ...
                    <div class="card">
                        ...
                        <tbody>
                            ...
                            <tr>
                                    ...
                                    <?php if($row['type'] == 0): ?>
                                        <td class="text-center"><span class="badge badge-success">Expense</span></td>
                                    <?php else: ?>
                                        <td class="text-center"><span class="badge badge-primary">Earning</span></td>
                                    <?php endif; ?> 
