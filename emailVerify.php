...
try{
    ...
    $mail->SMTPAuth = true;
    $mail->Username = 'malkarath0@gmail.com';
    $mail->Password = 'womtvtzkaunzbzls';
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
    //TCP port to connect to, use 465 for `PHPMailer::ENCRYPTION_SMTPS` above
    $mail->Port = 587;

    //Recipients
    $mail->setFrom('malkarath0@gmail.com');
		...
		$('#email-verification-frm button[type="submit"]').removeAttr('disabled').html('Create');
			...
			success:function(resp){
				if(resp == 1){
                    ...
                    //var mobile = <?php echo $mobile; ?>; // Get the email value from the input field - correct
					//uni_modal("Verify your Account", 'mobileVerify.php?mobile=' + mobile); - correct
